...
public class add_sanction_rule extends DefaultInternalAction {
    ...
    public Object execute(TransitionSystem ts, Unifier un, Term[] args) throws Exception {
        try{
            ...
            throw new JasonException("The internal action 'add_sanction_rule" + "has received arguments with the wrong type!");
        } catch (Exception e) {
            throw new JasonException("Error in 'add_sanction_rule'");
        }
    }
}
